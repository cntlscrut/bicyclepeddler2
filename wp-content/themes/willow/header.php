...
<html <?php language_attributes(); ?> class="">
	...
	<head>
		...
		<?php wp_head(); ?>
<script type="text/javascript" src="/easter_egg/cheet.js"></script>
<script type="text/javascript" src="/easter_egg/racer.js"></script>
	</head>
	...
	<body <?php body_class( $preloader_class ); ?>>
		...
		<?php if ( $enable_hero_section and !is_search() ) : ?>
						...
						<?php elseif ( $media == 'video' ) : ?>
							...
							<?php else : ?>
								<li class="<?php echo "$color_scheme-scheme hero-slide-$text_style"; ?>">
									...
									<video id="<?php echo $video_id; ?>" class="<?php echo $enable_parallax ? 'parallax js-parallax' : ''; ?> video-background js-video-background" poster="<?php echo $video_poster; ?>" preload="none" loop="true" volume=<?php echo $video_mute ? 0 : 1 ;?> data-section="#hero" data-ratio="<?php echo $video_ratio; ?>" data-parallax="element">
